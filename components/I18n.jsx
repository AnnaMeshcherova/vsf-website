...
const STRINGS = {
  en: {
    ...
    "adv.mila.p": "Direct access to a dense ecosystem of AI researchers, enabling early insight into emerging breakthroughs, proprietary deal flow, and technical validation from day zero.",
    "adv.mila.s1": "AI researchers",
    "adv.mila.s1v": "1,500+",
    "adv.mila.s2": "Deal flow",
    "adv.mila.s2v": "Proprietary",
  ...
  fr: {
    ...
    "adv.mila.p": "Accès direct à un écosystème dense de chercheurs en IA, offrant une visibilité précoce sur les percées émergentes, un flux de transactions propriétaire et une validation technique dès le premier jour.",
    "adv.mila.s1": "Chercheurs en IA",
    "adv.mila.s1v": "1 500+",
    "adv.mila.s2": "Flux de transactions",
    "adv.mila.s2v": "Propriétaire",
