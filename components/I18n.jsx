...
const STRINGS = {
  en: {
    ...
    "thesis.p2.2": ", and they emerge directly from the frontier of research, where new capabilities are first discovered. And where new companies are born.",
    "thesis.p3.1": "The next generation of generational AI companies will come from this same place: the intersection of ",
  ...
  fr: {
    ...
    "thesis.p2.vs": "Venture Scientists",
    "thesis.p2.2": ". Ils émergent directement de la frontière de la recherche, là où de nouvelles capacités sont découvertes. Et où naissent de nouvelles entreprises.",
    "thesis.p3.1": "La prochaine génération d'entreprises d'IA marquantes viendra de ce même lieu : l'intersection entre la ",
